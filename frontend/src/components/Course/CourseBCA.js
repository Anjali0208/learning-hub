      ...
      <div className="course">
        ...
        >
          ...
          <Col>
            ...
            <li>
              {" "}
              <Link to="/java_lab" className="link">
                Enterprise Computing with JAVA
              </Link>
            </li>
            <li>
              <Link to="/dbms" className="link">
          ...
          <Col>
            ...
            <li>
              <Link to="/java" className="link">
                Web Intelligence and Big Data Machine
              </Link>
            </li>
            <li>
              {" "}
              <Link to="/cn_lab" className="link">
                Flutter and Dart
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="" className="link">
                Multimedia TechnologiesInternet of Things
              </Link>
            </li>
            <li>
              <Link to="" className="link">
